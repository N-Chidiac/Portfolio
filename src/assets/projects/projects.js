export const projects = [
  ...
  },
  {
    ...
    image: "./projects/keuringen.png",
    description: [
      "Voor dit project ontwikkelde ik een applicatie voor het beheren en opvolgen van periodieke keuringen van arbeidsmiddelen en installaties, gebouwd tijdens een studentenjob bij Polymer Contractors. Elk toestel krijgt een unieke QR-code die naar een publieke overzichtspagina leidt, terwijl beheerders via een dashboard, kalender en toestellenoverzicht in één oogopslag zien welke keuringen binnenkort of al te laat zijn.",
      "De focus lag op een volledige full-stack applicatie met Vue 3, Vue Router en Pinia aan de frontend, en Node.js/Express met een SQLite/Turso-database aan de backend, aangevuld met JWT-authenticatie voor het beheerdersgedeelte. Ik werkte met een camera-gebaseerde QR-scanner, automatische statusberekening op basis van keuringsfrequentie en -historiek, foto-uploads met lui geladen thumbnails, CSV-export en bulk-acties op de toestellenlijst, en volledig beheerbare keuzelijsten voor locaties, categorieën, verantwoordelijken en keuringsfirma's.",
      "Dit project leerde me hoe je een datamodel opzet waarbij de status van een toestel nooit rechtstreeks bewerkbaar is maar altijd afgeleid wordt uit de keuringshistoriek, en gaf me ervaring met praktische aandachtspunten zoals archiveren in plaats van verwijderen, een respijtperiode vóór iets als achterstallig telt, en end-to-end tests die zowel de frontend als de backend-endpoints dekken.",
    ],
    type: "Student job project",
    github: "",
    date: "04-09-2026",
